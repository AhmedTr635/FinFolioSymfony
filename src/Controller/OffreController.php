...
class OffreController extends AbstractController
{
    ...
    {
        // Assuming the user ID is 113
        $userId = $this->getUser()->getId();

        // Fetch offers received by the user with ID 113
        $offresS = $offreRepository->findBy(['user_id' => $userId]);
...
//        return $this->json(['message' => 'Offer added successfully']);
    ...
    public function index1(OffreRepository $offreRepository): Response
    {
        ...
        $userId = $this->getUser()->getId(); // Assuming the user ID is 106
        ...
        // Fetch offers where the credit's user_id is 113
        $receivedOffres = $offreRepository->findReceivedOffersByUserId($this->getUser()->getId());



        // You can further process the received offers as needed

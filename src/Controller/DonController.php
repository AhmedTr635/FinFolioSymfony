...
class DonController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,TaxController $taxC): Response
    {
        $don = new Don();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
//////////////////////////////
            $currentTotalTax = $taxC->sommeTax();

            // Subtract the amount of the donation from the total tax sum
            $updatedTotalTax = $currentTotalTax - $don->getMontantUser();

            // Redirect to the depense index page and pass the updated total tax sum
            return $this->redirectToRoute('app_depense_index', ['updatedTotalTax' => $updatedTotalTax]);
        }

...
class GoogleAuthenticator extends OAuth2Authenticator
{
    ...
    public function __construct(private UrlGeneratorInterface $urlGenerator,ClientRegistry $clientRegistry, EntityManagerInterface $entityManager, RouterInterface $router,UserRepository $usersRepository)
    {

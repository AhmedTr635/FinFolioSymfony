...
{
    public function generatePDF(array $actif): string
    {
        // Initialisation de TCPDF
        $pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
        $pdf->AddPage();
        foreach ($actif as $actifs_courant) {
            $pdf->Cell(60, 10, $actifs_courant['name'], 'LR', 0, 'C');
            $pdf->Cell(40, 10, $actifs_courant['valeur'], 'LR', 0, 'C');
